    ...
    <div className="page pt-5">
      ...
      >
        <p className="text-[13px] text-ink-600">
          Полезно, если вы «наигрались» со статусами заявок и хотите начать сценарий заново:
          отправить заявку, подтвердить её в кабинете поставщика, доставить и провести приёмку.
        </p>
      </Modal>
    </div>
  );
