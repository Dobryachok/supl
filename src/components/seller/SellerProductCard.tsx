...
export function SellerProductCard({
  ...
  return (
    <article
      className={cn(
        'flex h-full flex-col overflow-hidden rounded-xl border bg-white shadow-[var(--shadow-card)]',
    ...
    >
      <div className="relative shrink-0">
        ...
        {onSelectChange && (
          <div className="absolute top-2 right-2 z-10 flex size-8 items-center justify-center rounded-lg bg-white/95 shadow-sm ring-1 ring-ink-200/80">
            <Checkbox
              checked={selected}
      ...
      <div className="flex flex-1 flex-col p-3">
        <Link
          ...
          className="line-clamp-2 min-h-[2.5rem] text-[13px] leading-5 font-semibold text-ink-900 hover:text-brand-700"
        >
          {product.name}
        </Link>
